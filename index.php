...
<div class="sign-in round">
    <div class="card shadow text-center">
        ...
        <?php } ?>
        <!-- form container -->
        <form action="controller/index.php" method="post" class="px-3">
            ...
            <div class="container my-1">
                ...
                <span href="#" class="btn text-center form-control text-danger border-0">Already have Account <a href="login.php" class="text-center">sign in</a></span>
